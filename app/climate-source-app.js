...
var generate_button = ui.Button('Sample points', function() {
  ...
  panel_right_chart.add(ui.Label((daymet_dict[key_daymet][1]).toFixed(1) + ' _____________________________ ' + (daymet_dict[key_daymet][2]).toFixed(1)));
  ...
  panel_left_chart.add(ui.Label((era5_dict[key_era5][1]).toFixed(1) + ' _____________________________ ' + (era5_dict[key_era5][2]).toFixed(1)));
