...
var geometry = /* color: #d63000 */ee.FeatureCollection(
        [ee.Feature(
            ee.Geometry.Point([-120.01339170395872, 54.82097540279146]),
            {
              "system:index": "0"
            }),
        ee.Feature(
            ee.Geometry.Point([-116.94820615708372, 56.69970979965382]),
            {
              "system:index": "1"
            }),
        ee.Feature(
            ee.Geometry.Point([-118.67246694131055, 56.154441684771434]),
            {
              "system:index": "2"
            }),
        ee.Feature(
            ee.Geometry.Point([-136.91728237631563, 60.982984401796536]),
            {
              "system:index": "3"
            }),
        ee.Feature(
            ee.Geometry.Point([-140.69657925131563, 62.12368198955072]),
            {
              "system:index": "4"
            }),
        ee.Feature(
            ee.Geometry.Point([-140.76982845442157, 63.46615402037919]),
            {
              "system:index": "5"
            }),
        ee.Feature(
            ee.Geometry.Point([-137.26518978254657, 63.15528203910088]),
            {
              "system:index": "6"
            }),
        ee.Feature(
            ee.Geometry.Point([-137.78154720442157, 62.58922824931989]),
            {
              "system:index": "7"
            }),
        ee.Feature(
            ee.Geometry.Point([-124.40657790241876, 48.68503849266654]),
            {
              "system:index": "8"
            }),
        ee.Feature(
            ee.Geometry.Point([-124.62630446491876, 49.190201734866044]),
            {
              "system:index": "9"
            }),
        ee.Feature(
            ee.Geometry.Point([-125.83480055866876, 49.37653263200246]),
            {
              "system:index": "10"
            }),
        ee.Feature(
            ee.Geometry.Point([-126.16439040241876, 50.17115295052788]),
            {
              "system:index": "11"
            }),
        ee.Feature(
            ee.Geometry.Point([-127.30696852741876, 50.24146818840383]),
            {
              "system:index": "12"
            }),
        ee.Feature(
