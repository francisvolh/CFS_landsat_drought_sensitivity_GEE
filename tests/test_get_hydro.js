...
print(hand_30_1000);
Map.addLayer(hand_30_1000, {min:0, max:500, palette:p}, 'hand 30 1000');

var hand_90_1000 = get_hydro.get_hand(90, 1000);
print(hand_90_1000);
Map.addLayer(hand_90_1000, {min:0, max:500, palette:p}, 'hand 90 1000');
...
Map.addLayer(prop_snow_1000, {min:0, max:1}, 'prop snow 1000');
