...
var min_year = 2010;
var ndvi = landsat.indices_greenest(min_year, 2012, '07-01', '08-31', geometry);



// Map anthro, agriculture, land cover masks
Map.addLayer(ee.Image.constant(0), {palette: '#000000'}, 'Background');
Map.addLayer(anthro.world_settlement_area, {palette: ['#ccc848', '#ffffff'], opacity: 0.5}, 'World Settlement Area');
Map.addLayer(agriculture.agriculture.not(), {palette: ['#44bf3c', '#ffffff'], opacity: 0.5}, 'Agriculture');
