...
Map.addLayer(fire.five_year_fires(2011), {palette: ['#ffffff', '#ff5e5e'], opacity: 0.5}, '2011 fires');
Map.addLayer(anthro.harvest_year.eq(2011), {palette: ['#ffffff', '#ff5e5e'], opacity: 0.5}, '2011 harvest');
