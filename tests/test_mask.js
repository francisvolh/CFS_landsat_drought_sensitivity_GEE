...
Map.addLayer(anthro.world_settlement_area, {palette: '#ccc848', opacity: 0.5}, 'World Settlement Area');
Map.addLayer(agriculture.agriculture_mask, {palette: '#44bf3c', opacity: 0.5}, 'Agriculture');
