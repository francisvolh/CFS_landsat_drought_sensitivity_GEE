...
Map.addLayer(geomorpho.select('dxx'), {min: -0.5, max: 0.5, palette: p}, 'dxx', false);
Map.addLayer(geomorpho.select('dxy'), {min: -0.5, max: 0.5, palette: p}, 'dxy', false);
Map.addLayer(geomorpho.select('dyy'), {min: -0.5, max: 0.5, palette: p}, 'dyy', false);
