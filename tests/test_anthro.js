...
Map.addLayer(harvest_year, {palette: ['#000000', '#ffc0c0','#be0900'], min: 1985, max:2020, opacity: 0.8}, 'Harvest year');
...
Map.addLayer(harvest_year.eq(2011), {opacity: 0.8}, 'Harvest mask year 2010', false);
