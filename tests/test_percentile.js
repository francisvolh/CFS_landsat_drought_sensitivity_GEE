...
print('Within percentile'); print(wi_percent);
Map.addLayer(wi_percent.select('CMI_ante3mo_lt_p15_gt_p85').first(), {min:0, max:1}, '2010 CMI lt 15th-85th p 3 month antecedent');
