...
var sensitivity_absolute_cap = function(split_indices, antecedent_list, percentile_low, index_list) {
  ...
  return ee.Image(antecedent_list.map(function(antecedent_period) {
      return index_list.map(function(index) {
          var id = index + '_ante' + antecedent_period + '_p' + percentile_low;
...
var sensitivity_relative_cap = function(split_indices, antecedent_list, percentile_low, index_list) {
	var means = split_indices.mean();
  return ee.Image(antecedent_list.map(function(antecedent_period) {
      return index_list.map(function(index) {
          var id = index + '_ante' + antecedent_period + '_p' + percentile_low;
