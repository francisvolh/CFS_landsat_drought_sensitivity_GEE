...
var get_percentile_masks = function(ante_images, percentile_images) {
    ...
    var out = ee.Image([
      ...
      ante_img.select('CMI_ante5yr_mean_min').gt(percentile_images.select('CMI_ante5yr_mean_min_p15'))
        .and(ante_img.select('CMI_ante5yr_mean_min').lt(percentile_images.select('CMI_ante5yr_mean_min_p85')))
