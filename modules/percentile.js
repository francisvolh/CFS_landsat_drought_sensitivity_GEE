...
var lt_percentile = function(images, percentile_images) {
    ...
    var out = ee.Image([
      ...
      percentile_images.select('CMI_ante12mo_p15').gte(img.select('CMI_ante12mo_mean')),
      percentile_images.select('CMI_ante5yr_p15').gte(img.select('CMI_ante5yr_mean_min')),
