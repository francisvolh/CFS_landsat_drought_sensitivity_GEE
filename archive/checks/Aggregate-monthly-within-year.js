...
// var byYr = agg.aggregateY(years, daymet, ee.Reducer.mean())
var byMnthYr = agg.aggregateMY(years, months, daymet, ee.Reducer.mean());

// Map
Map.addLayer(byMnthYr.limit(5).select('tmax_mean'));
