...
var tmax = daymet.select('tmax').toBands();
var tmin = daymet.select('tmin').toBands();
...
// Combine ---------------------------------------------------------
var max = ee.Image([terra.select('tmmx').divide(10), tmax]);
var min = ee.Image([terra.select('tmmn').divide(10), tmin]);
